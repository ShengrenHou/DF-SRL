...
def create_cigre_lv_resident():
    ...
    # Linedata
    # UG1, we create the UG1 type of line and then later create the real line
    ...
    # Loads
    ## here we initialize the load data to get a intial power flow?
...
#   we use the internal data from pandapower
    print(net)
    pp.runpp(net)
    data=net._ppc
    bus=data['bus']
